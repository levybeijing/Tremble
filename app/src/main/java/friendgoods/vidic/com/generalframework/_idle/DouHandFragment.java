 ...
 */
public class DouHandFragment extends LazyFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.fragment_douhand, null);
...
//        mMainRecycler.setXListViewListener(this);
        ...
        final TextView tv_number = view.findViewById(R.id.tv_number_douhand);
        tv_number.setText(number+"");
        TextView tv_time = view.findViewById(R.id.tv_time_douhand);
//        字体设置
        Typeface font=null;
