...
public class RefreshRecyclerView extends WrapRecyclerView {
    ...
    // 松开刷新状态
    public int REFRESH_STATUS_READY_REFRESHING = 0x0033;
    // 正在刷新状态
...
//最终的距离顶部位置
        ...
        if (mCurrentRefreshStatus == REFRESH_STATUS_READY_REFRESHING) {
            finalTopMargin = 0;
...
//                    通过距离改变加载状态
    ...
    private void updateRefreshStatus(int marginTop) {
        if (marginTop <= -mRefreshViewHeight) {
            ...
            mCurrentRefreshStatus = REFRESH_STATUS_READY_REFRESHING;
        }
