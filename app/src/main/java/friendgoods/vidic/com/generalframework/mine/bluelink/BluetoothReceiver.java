package friendgoods.vidic.com.generalframework.mine.bluelink;
...
//            if(btDevice.getName().contains("BLU58"))//HC-05设备如果有多个，第一个搜到的那个会被尝试。
//            {
////                Log.e("************", "onReceive: "+btDevice.getAddress());
...
//            if(btDevice.getName().contains("BLU58"))
//            {
//                Log.e("here", "OKOKOK");
//
//                try {
