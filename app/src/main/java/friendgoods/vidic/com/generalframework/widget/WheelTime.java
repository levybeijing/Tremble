...
import friendgoods.vidic.com.generalframework.adapter.ArrayWheelAdapter;
import friendgoods.vidic.com.generalframework.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        wv_minutes = (WheelView) view.findViewById(com.bigkoo.pickerview.R.id.min);
        ...
        wv_seconds = (WheelView) view.findViewById(com.bigkoo.pickerview.R.id.second);
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_hours != null) {
            ...
            wv_hours.setLabel(view.getContext().getString(com.bigkoo.pickerview.R.string.pickerview_hours));
        }
        if (label_mins != null) {
            wv_minutes.setLabel(label_mins);
        } else {
            wv_minutes.setLabel(view.getContext().getString(com.bigkoo.pickerview.R.string.pickerview_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(com.bigkoo.pickerview.R.string.pickerview_seconds));
        }
